...
INSERT OR IGNORE INTO settings (id, company_name, company_tagline, address, city, state, pincode, phone, email, website, gstin, pan, cin, currency, financial_year_start, salary_basis_days, pf_rate, pf_cap, pf_eligibility, esic_rate, esic_eligibility, professional_tax_amount, professional_tax_min_gross, default_ot_rate, attendance_lock_enabled, lwf_employee_amount, lwf_employer_amount, tds_percent)
VALUES (1, 'Staffsway', 'Manpower Staffing & HRMS', '501 Corporate Tower, Andheri East', 'Mumbai', 'Maharashtra', '400069', '+91 22 4890 2200', 'info@staffsway.in', 'https://staffsway.in', '27AABCP8892Q1Z5', 'AABCP8892Q', 'U74900MH2014PTC284110', 'INR', 4, 26, 12, 1800, 15000, 0.75, 21000, 200, 10000, 80, 1, 100, 100, 2);
...
INSERT OR IGNORE INTO clients (id, client_code, name, primary_contact_person, hr_contact_person, company_email, address_line1, address_line2, city, state, district, pincode, gst_no, company_pan, payroll_cycle, salary_calculation, overtime_enabled, leave_policy_enabled, arrears_enabled, advance_loan_enabled, bank_name, bank_account, bank_ifsc, bank_account_holder, status) VALUES
  (1, 'AFS', 'ABC Facility Services', 'Anil Kapoor', 'Meena Kapoor', 'accounts@abcfacilities.in', '210 Trade Centre', 'Andheri East', 'Mumbai', 'Maharashtra', 'Mumbai Suburban', '400069', '27AABCV1234F1Z5', 'AABCV1234F', 'monthly', 'calendar_days', 1, 1, 1, 1, 'HDFC Bank', '60010000000001', 'HDFC0000401', 'ABC Facility Services', 'active'),
  ...
  (3, 'SI', 'SecureTech Industries', 'Rajesh Menon', 'Lakshmi Iyer', 'hr@securetech.in', 'Plot 12, Industrial Estate', 'Ambattur', 'Chennai', 'Tamil Nadu', 'Chennai', '600058', '33AABCS1234F1Z3', 'AABCS1234F', 'monthly', 'calendar_days', 0, 1, 1, 0, 'State Bank of India', '80010000000003', 'SBIN0009988', 'SecureTech Industries', 'active'),
  (4, 'GH', 'Greenfield Hospital', 'Dr. Sunita Rao', 'Dr. K. Shah', 'admin@greenfieldhosp.in', '5 Andheri West', 'Andheri', 'Mumbai', 'Maharashtra', 'Mumbai Suburban', '400053', '27AACFG1234H1Z4', 'AACFG1234H', 'monthly', 'working_days', 1, 1, 1, 1, 'Axis Bank', '90010000000004', 'UTIB0000444', 'Greenfield Hospital', 'active');

INSERT OR IGNORE INTO sites (id, client_id, name, status, address_line1, address_line2, city, state, district, pincode, site_incharge, site_incharge_designation, site_incharge_contact, site_incharge_email, shift_type, overtime_enabled, payroll_applicable, leave_policy_enabled, arrears_enabled, pf_applicable, pf_percent, esic_applicable, esic_percent, lwf_applicable, lwf_percent, pt_applicable, pt_amount, tds_applicable, tds_percent, gratuity_applicable) VALUES
  (1, 1, 'Corporate Park Chennai', 'active', '1 Highfield Road', 'Corporate Park, Guindy', 'Chennai', 'Tamil Nadu', 'Chennai', '600028', 'R. Subramaniam', 'Site Incharge', '98400 11001', 'rcs@corporatepark.in', 'General', 1, 1, 1, 1, 1, 12, 1, 0.75, 1, 0.5, 1, 200, 1, 2, 1),
  (2, 1, 'Highland Towers Mumbai', 'active', '22 Marine Drive', 'Highland Towers', 'Mumbai', 'Maharashtra', 'Mumbai', '400002', 'V. Kulkarni', 'Site Supervisor', '98400 11002', 'vk@highlandtowers.in', 'Rotational', 1, 1, 1, 0, 1, 12, 1, 0.75, 0, 0.5, 1, 200, 1, 2, 1),
  (3, 1, 'Riverside Tech Hub Bengaluru', 'active', '88 Koramangala', 'Riverside Tech Hub', 'Bengaluru', 'Karnataka', 'Bengaluru Urban', '560095', 'M. Narayan', 'Facility Manager', '98400 11003', 'mn@riversidetech.in', 'General', 1, 1, 1, 1, 1, 12, 1, 0.75, 1, 0.5, 1, 200, 1, 2, 1),
  (4, 2, 'City Centre Mall Pune', 'active', '45 FC Road', 'City Centre Mall', 'Pune', 'Maharashtra', 'Pune', '411004', 'A. Deshpande', 'Security Supervisor', '98400 11004', 'ad@citycentremall.in', 'Morning', 1, 1, 1, 1, 1, 12, 1, 0.75, 0, 0.5, 1, 200, 1, 2, 1),
  (5, 2, 'Grand Galleria Mall Hyderabad', 'active', '7 Banjara Hills', 'Grand Galleria Mall', 'Hyderabad', 'Telangana', 'Hyderabad', '500034', 'P. Varma', 'Site Incharge', '98400 11005', 'pv@grandgalleria.in', 'Rotational', 1, 1, 1, 0, 1, 12, 1, 0.75, 1, 0.5, 1, 200, 1, 2, 1),
  (6, 2, 'Urban Square Mall Delhi', 'active', '101 Connaught Place', 'Urban Square Mall', 'New Delhi', 'Delhi', 'Central Delhi', '110001', 'S. Khanna', 'Security Head', '98400 11006', 'sk@urbansquare.in', 'Rotational', 1, 1, 1, 1, 1, 12, 1, 0.75, 0, 0.5, 1, 200, 1, 2, 1),
  (7, 3, 'Alpha Industrial Estate Chennai', 'active', '33 Ambattur Industrial Estate', 'Alpha Industrial Estate', 'Chennai', 'Tamil Nadu', 'Chennai', '600058', 'R. Venkatesan', 'Site Incharge', '98400 11007', 'rv@alphaindustrial.in', 'Night', 1, 1, 1, 1, 1, 12, 1, 0.75, 1, 0.5, 1, 200, 1, 2, 1),
  (8, 3, 'Sigma Electronics Park Bengaluru', 'active', '12 Whitefield', 'Sigma Electronics Park', 'Bengaluru', 'Karnataka', 'Bengaluru Urban', '560066', 'T. Prabhakar', 'Security Supervisor', '98400 11008', 'tp@sigmapark.in', 'General', 1, 1, 1, 0, 1, 12, 1, 0.75, 0, 0.5, 1, 200, 1, 2, 1),
  (9, 4, 'Greenfield Main Hospital Mumbai', 'active', '5 Andheri West', 'Greenfield Main Hospital', 'Mumbai', 'Maharashtra', 'Mumbai Suburban', '400053', 'Dr. K. Shah', 'Security Incharge', '98400 11009', 'ks@greenfieldhosp.in', 'Rotational', 1, 1, 1, 1, 1, 12, 1, 0.75, 1, 0.5, 1, 200, 1, 2, 1),
  (10, 4, 'Greenfield Annex Clinic Pune', 'active', '118 Kothrud', 'Greenfield Annex Clinic', 'Pune', 'Maharashtra', 'Pune', '411038', 'Dr. A. Joshi', 'Site Incharge', '98400 11010', 'aj@greenfieldhosp.in', 'General', 1, 1, 1, 1, 1, 12, 1, 0.75, 0, 0.5, 1, 200, 1, 2, 1);

INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (1, 'SW0001', 'Rahul', 'Sharma', 'Suresh Sharma', 'Male', '1988-04-12', '98100 10001', 'rahul.sharma@staffsway.in', '789600000001', 'Chennai, Tamil Nadu 600028', 'Chennai', 'Tamil Nadu', '600028', 'Ajay Sharma', '9820000137', 'HDFC Bank', '60010000000001', 'HDFC0000401', 'AABPC0001K', '101000000001', '2023-01-10', 'Security Supervisor', 'Security', 'B', NULL, NULL, 'permanent', 'General', 1, 'active');
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (2, 'SW0002', 'Amit', 'Verma', 'Mahesh Verma', 'Male', '1992-07-23', '98100 10002', 'amit.verma@staffsway.in', '789600000002', 'Chennai, Tamil Nadu 600028', 'Chennai', 'Tamil Nadu', '600028', 'Prakash Verma', '9820000274', 'State Bank of India', '60010000000002', 'SBIN0009988', 'AABPC0002K', '101000000002', '2023-02-14', 'Security Guard', 'Security', 'B', 'Rahul Sharma', NULL, 'permanent', 'General', 1, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (3, 'SW0003', 'Sanjay', 'Gupta', 'Dinesh Gupta', 'Male', '1990-11-05', '98100 10003', 'sanjay.gupta@staffsway.in', '789600000003', 'Chennai, Tamil Nadu 600028', 'Chennai', 'Tamil Nadu', '600028', 'Harish Gupta', '9820000411', 'ICICI Bank', '60010000000003', 'ICIC0001020', 'AABPC0003K', '101000000003', '2023-03-01', 'Security Guard', 'Security', 'C', 'Rahul Sharma', 'Previously at CityWatch Security (4 yrs)', 'contract', 'Night', 1, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (4, 'SW0004', 'Vikas', 'Yadav', 'Rakesh Yadav', 'Male', '1987-02-17', '98100 10004', 'vikas.yadav@staffsway.in', '789600000004', 'Chennai, Tamil Nadu 600028', 'Chennai', 'Tamil Nadu', '600028', 'Ganesh Yadav', '9820000548', 'Axis Bank', '60010000000004', 'UTIB0000123', 'AABPC0004K', '101000000004', '2023-01-20', 'Electrician', 'Technical', 'B', 'Rahul Sharma', NULL, 'permanent', 'General', 1, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (5, 'SW0005', 'Mohan', 'Das', 'Naresh Das', 'Male', '1995-09-30', '98100 10005', 'mohan.das@staffsway.in', '789600000005', 'Chennai, Tamil Nadu 600028', 'Chennai', 'Tamil Nadu', '600028', 'Vijay Das', '9820000685', 'Canara Bank', '60010000000005', 'CNRB0001999', 'AABPC0005K', '101000000005', '2024-04-05', 'Office Boy', 'Administration', 'C', 'Rahul Sharma', NULL, 'permanent', 'General', 1, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (8, 'SW0008', 'Deepak', 'Singh', 'Ramesh Singh', 'Male', '1993-03-25', '98100 10008', 'deepak.singh@staffsway.in', '789600000008', 'Mumbai, Maharashtra 400002', 'Mumbai', 'Maharashtra', '400002', 'Harish Singh', '9820001096', 'HDFC Bank', '60010000000008', 'HDFC0000401', 'AABPC0008K', '101000000008', '2023-06-12', 'Security Guard', 'Security', 'C', NULL, 'Previously at SecureGuard Services (4 yrs)', 'contract', 'Night', 2, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (9, 'SW0009', 'Manoj', 'Tiwari', 'Suresh Tiwari', 'Male', '1996-08-14', '98100 10009', 'manoj.tiwari@staffsway.in', '789600000009', 'Mumbai, Maharashtra 400002', 'Mumbai', 'Maharashtra', '400002', 'Ganesh Tiwari', '9820001233', 'State Bank of India', '60010000000009', 'SBIN0009988', 'AABPC0009K', '101000000009', '2024-02-20', 'Cleaner', 'Housekeeping', 'C', NULL, NULL, 'permanent', 'Morning', 2, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (10, 'SW0010', 'Raju', 'Patel', 'Mahesh Patel', 'Male', '1986-10-02', '98100 10010', 'raju.patel@staffsway.in', '789600000010', 'Mumbai, Maharashtra 400002', 'Mumbai', 'Maharashtra', '400002', 'Vijay Patel', '9820001370', 'ICICI Bank', '60010000000010', 'ICIC0001020', 'AABPC0010K', '101000000010', '2023-07-17', 'Plumber', 'Technical', 'B', NULL, 'Previously at SafeHands Manpower (1 yrs)', 'contract', 'General', 2, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (12, 'SW0012', 'Nitin', 'Shetty', 'Rakesh Shetty', 'Male', '1989-06-21', '98100 10012', 'nitin.shetty@staffsway.in', '789600000012', 'Bengaluru, Karnataka 560095', 'Bengaluru', 'Karnataka', '560095', 'Prakash Shetty', '9820001644', 'Canara Bank', '60010000000012', 'CNRB0001999', 'AABPC0012K', '101000000012', '2023-03-18', 'Security Supervisor', 'Security', 'B', NULL, NULL, 'permanent', 'General', 3, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (15, 'SW0015', 'Pooja', 'Sharma', 'Bhaskar Sharma', 'Female', '1996-05-16', '98100 10015', 'pooja.sharma@staffsway.in', '789600000015', 'Bengaluru, Karnataka 560095', 'Bengaluru', 'Karnataka', '560095', 'Vijay Sharma', '9820002055', 'HDFC Bank', '60010000000015', 'HDFC0000401', 'AABPC0015K', '101000000015', '2024-08-01', 'Receptionist', 'Administration', 'B', 'Nitin Shetty', NULL, 'permanent', 'General', 3, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (16, 'SW0016', 'Sunil', 'Pawar', 'Ramesh Pawar', 'Male', '1987-03-06', '98100 10016', 'sunil.pawar@staffsway.in', '789600000016', 'Pune, Maharashtra 411004', 'Pune', 'Maharashtra', '411004', 'Ajay Pawar', '9820002192', 'State Bank of India', '60010000000016', 'SBIN0009988', 'AABPC0016K', '101000000016', '2023-02-01', 'Housekeeping Supervisor', 'Housekeeping', 'B', NULL, NULL, 'permanent', 'Morning', 4, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (17, 'SW0017', 'Vijay', 'More', 'Suresh More', 'Male', '1995-07-19', '98100 10017', 'vijay.more@staffsway.in', '789600000017', 'Pune, Maharashtra 411004', 'Pune', 'Maharashtra', '411004', 'Prakash More', '9820002329', 'ICICI Bank', '60010000000017', 'ICIC0001020', 'AABPC0017K', '101000000017', '2024-01-10', 'Housekeeping Staff', 'Housekeeping', 'C', 'Sunil Pawar', 'Previously at Metro Facilities (3 yrs)', 'contract', 'Morning', 4, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (18, 'SW0018', 'Sandeep', 'Kulkarni', 'Mahesh Kulkarni', 'Male', '1990-12-03', '98100 10018', 'sandeep.kulkarni@staffsway.in', '789600000018', 'Pune, Maharashtra 411004', 'Pune', 'Maharashtra', '411004', 'Harish Kulkarni', '9820002466', 'Axis Bank', '60010000000018', 'UTIB0000123', 'AABPC0018K', '101000000018', '2023-05-20', 'Security Guard', 'Security', 'C', 'Sunil Pawar', NULL, 'permanent', 'Morning', 4, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (19, 'SW0019', 'Mahesh', 'Joshi', 'Dinesh Joshi', 'Male', '1984-04-25', '98100 10019', 'mahesh.joshi@staffsway.in', '789600000019', 'Pune, Maharashtra 411004', 'Pune', 'Maharashtra', '411004', 'Ganesh Joshi', '9820002603', 'Canara Bank', '60010000000019', 'CNRB0001999', 'AABPC0019K', '101000000019', '2024-03-15', 'Gardener', 'Housekeeping', 'C', 'Sunil Pawar', 'Previously at CityWatch Security (5 yrs)', 'contract', 'Morning', 4, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (20, 'SW0020', 'Srinivas', 'Rao', 'Rakesh Rao', 'Male', '1991-08-22', '98100 10020', 'srinivas.rao@staffsway.in', '789600000020', 'Hyderabad, Telangana 500034', 'Hyderabad', 'Telangana', '500034', 'Vijay Rao', '9820002740', 'Bank of Baroda', '60010000000020', 'BARB0000112', 'AABPC0020K', '101000000020', '2023-06-01', 'Security Guard', 'Security', 'B', NULL, NULL, 'permanent', 'Rotational', 5, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (22, 'SW0022', 'Ganesh', 'Patil', 'Mukesh Patil', 'Male', '1989-01-13', '98100 10022', 'ganesh.patil@staffsway.in', '789600000022', 'Hyderabad, Telangana 500034', 'Hyderabad', 'Telangana', '500034', 'Prakash Patil', '9820003014', 'HDFC Bank', '60010000000022', 'HDFC0000401', 'AABPC0022K', '101000000022', '2023-09-01', 'Driver', 'Transport', 'B', NULL, NULL, 'permanent', 'Morning', 5, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (23, 'SW0023', 'Harish', 'Kumar', 'Bhaskar Kumar', 'Male', '1992-02-07', '98100 10023', 'harish.kumar@staffsway.in', '789600000023', 'New Delhi, Delhi 110001', 'New Delhi', 'Delhi', '110001', 'Harish Kumar', '9820003151', 'State Bank of India', '60010000000023', 'SBIN0009988', 'AABPC0023K', '101000000023', '2023-10-02', 'Security Guard', 'Security', 'C', NULL, NULL, 'permanent', 'Rotational', 6, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (24, 'SW0024', 'Rohit', 'Arora', 'Ramesh Arora', 'Male', '1988-09-18', '98100 10024', 'rohit.arora@staffsway.in', '789600000024', 'New Delhi, Delhi 110001', 'New Delhi', 'Delhi', '110001', 'Ganesh Arora', '9820003288', 'ICICI Bank', '60010000000024', 'ICIC0001020', 'AABPC0024K', '101000000024', '2023-11-06', 'Electrician', 'Technical', 'B', NULL, NULL, 'permanent', 'General', 6, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (25, 'SW0025', 'Amit', 'Bansal', 'Suresh Bansal', 'Male', '1990-06-29', '98100 10025', 'amit.bansal@staffsway.in', '789600000025', 'New Delhi, Delhi 110001', 'New Delhi', 'Delhi', '110001', 'Vijay Bansal', '9820003425', 'Axis Bank', '60010000000025', 'UTIB0000123', 'AABPC0025K', '101000000025', '2024-02-01', 'Floor Executive', 'Facilities', 'B', NULL, NULL, 'permanent', 'Rotational', 6, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (26, 'SW0026', 'Vikram', 'Singh', 'Mahesh Singh', 'Male', '1986-11-04', '98100 10026', 'vikram.singh@staffsway.in', '789600000026', 'Chennai, Tamil Nadu 600058', 'Chennai', 'Tamil Nadu', '600058', 'Ajay Singh', '9820003562', 'Canara Bank', '60010000000026', 'CNRB0001999', 'AABPC0026K', '101000000026', '2023-07-01', 'Security Guard', 'Security', 'C', 'Selvam R', 'Previously at SafeHands Manpower (2 yrs)', 'contract', 'Night', 7, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (27, 'SW0027', 'Rajesh', 'Kumar', 'Dinesh Kumar', 'Male', '1991-05-27', '98100 10027', 'rajesh.kumar@staffsway.in', '789600000027', 'Chennai, Tamil Nadu 600058', 'Chennai', 'Tamil Nadu', '600058', 'Prakash Kumar', '9820003699', 'Bank of Baroda', '60010000000027', 'BARB0000112', 'AABPC0027K', '101000000027', '2023-08-10', 'Security Guard', 'Security', 'B', 'Selvam R', NULL, 'permanent', 'Night', 7, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (28, 'SW0028', 'Murugan', 'K', 'Rakesh K', 'Male', '1994-12-08', '98100 10028', 'murugan.k@staffsway.in', '789600000028', 'Chennai, Tamil Nadu 600058', 'Chennai', 'Tamil Nadu', '600058', 'Harish K', '9820003836', 'Punjab National Bank', '60010000000028', 'PUNB0484600', 'AABPC0028K', '101000000028', '2024-06-03', 'Housekeeping Staff', 'Housekeeping', 'C', 'Selvam R', 'Previously at SecureGuard Services (4 yrs)', 'contract', 'Night', 7, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (29, 'SW0029', 'Selvam', 'R', 'Naresh R', 'Male', '1986-03-15', '98100 10029', 'selvam.r@staffsway.in', '789600000029', 'Chennai, Tamil Nadu 600058', 'Chennai', 'Tamil Nadu', '600058', 'Ganesh R', '9820003973', 'HDFC Bank', '60010000000029', 'HDFC0000401', 'AABPC0029K', '101000000029', '2023-04-22', 'Electrician Supervisor', 'Technical', 'B', NULL, NULL, 'permanent', 'Night', 7, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (31, 'SW0031', 'Kiran', 'P', 'Bhaskar P', 'Male', '1993-06-27', '98100 10031', 'kiran.p@staffsway.in', '789600000031', 'Bengaluru, Karnataka 560066', 'Bengaluru', 'Karnataka', '560066', 'Ajay P', '9820004247', 'ICICI Bank', '60010000000031', 'ICIC0001020', 'AABPC0031K', '101000000031', '2023-10-14', 'Security Guard', 'Security', 'C', 'Anand Kumar', NULL, 'permanent', 'General', 8, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (32, 'SW0032', 'Dinesh', 'Babu', 'Ramesh Babu', 'Male', '1989-02-03', '98100 10032', 'dinesh.babu@staffsway.in', '789600000032', 'Bengaluru, Karnataka 560066', 'Bengaluru', 'Karnataka', '560066', 'Prakash Babu', '9820004384', 'Axis Bank', '60010000000032', 'UTIB0000123', 'AABPC0032K', '101000000032', '2023-05-18', 'HVAC Technician', 'Technical', 'B', 'Anand Kumar', NULL, 'permanent', 'General', 8, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (33, 'SW0033', 'Rakesh', 'Yadav', 'Suresh Yadav', 'Male', '1990-07-20', '98100 10033', 'rakesh.yadav@staffsway.in', '789600000033', 'Mumbai, Maharashtra 400053', 'Mumbai', 'Maharashtra', '400053', 'Harish Yadav', '9820004521', 'Canara Bank', '60010000000033', 'CNRB0001999', 'AABPC0033K', '101000000033', '2023-09-05', 'Medical Attendant', 'Medical Services', 'C', 'Suresh Menon', NULL, 'permanent', 'Rotational', 9, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (34, 'SW0034', 'Neha', 'Gupta', 'Mahesh Gupta', 'Female', '1995-04-09', '98100 10034', 'neha.gupta@staffsway.in', '789600000034', 'Mumbai, Maharashtra 400053', 'Mumbai', 'Maharashtra', '400053', 'Ganesh Gupta', '9820004658', 'Bank of Baroda', '60010000000034', 'BARB0000112', 'AABPC0034K', '101000000034', '2024-07-12', 'Housekeeping Staff', 'Housekeeping', 'C', 'Suresh Menon', NULL, 'permanent', 'Rotational', 9, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (35, 'SW0035', 'Suresh', 'Menon', 'Dinesh Menon', 'Male', '1984-08-30', '98100 10035', 'suresh.menon@staffsway.in', '789600000035', 'Mumbai, Maharashtra 400053', 'Mumbai', 'Maharashtra', '400053', 'Vijay Menon', '9820004795', 'Punjab National Bank', '60010000000035', 'PUNB0484600', 'AABPC0035K', '101000000035', '2022-11-01', 'Facility Supervisor', 'Facilities', 'A', NULL, NULL, 'permanent', 'General', 9, 'active');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (36, 'SW0036', 'Prakash', 'Iyer', 'Rakesh Iyer', 'Male', '1987-12-11', '98100 10036', 'prakash.iyer@staffsway.in', '789600000036', 'Pune, Maharashtra 411038', 'Pune', 'Maharashtra', '411038', 'Ajay Iyer', '9820004932', 'HDFC Bank', '60010000000036', 'HDFC0000401', 'AABPC0036K', '101000000036', '2023-06-08', 'Security Guard', 'Security', 'C', NULL, NULL, 'permanent', 'Rotational', 10, 'inactive');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (37, 'SW0037', 'Meena', 'Kumari', 'Naresh Kumari', 'Female', '1992-01-17', '98100 10037', 'meena.kumari@staffsway.in', '789600000037', 'Pune, Maharashtra 411038', 'Pune', 'Maharashtra', '411038', 'Prakash Kumari', '9820005069', 'State Bank of India', '60010000000037', 'SBIN0009988', 'AABPC0037K', '101000000037', '2024-03-22', 'Cleaner', 'Housekeeping', 'C', NULL, 'Previously at Metro Facilities (3 yrs)', 'contract', 'Morning', 10, 'inactive');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
...
INSERT OR IGNORE INTO employees (id, employee_code, first_name, last_name, father_name, gender, dob, mobile, email, aadhaar, address, city, state, pincode, emergency_contact_name, emergency_contact_phone, bank_name, bank_account, bank_ifsc, pan, uan, joining_date, designation, department, grade, reporting_manager, previous_employment, employee_type, shift_type, site_id, status)
VALUES (38, 'SW0038', 'Babu', 'Lal', 'Mukesh Lal', 'Male', '1985-10-05', '98100 10038', 'babu.lal@staffsway.in', '789600000038', 'Pune, Maharashtra 411038', 'Pune', 'Maharashtra', '411038', 'Harish Lal', '9820005206', 'ICICI Bank', '60010000000038', 'ICIC0001020', 'AABPC0038K', '101000000038', '2023-02-25', 'Driver', 'Transport', 'B', NULL, NULL, 'permanent', 'Morning', 10, 'inactive');
INSERT OR IGNORE INTO salary_structures (id, employee_id, effective_from, basic, hra, conveyance, other_allowance, overtime_rate, pf_applicable, esic_applicable, other_deduction)
